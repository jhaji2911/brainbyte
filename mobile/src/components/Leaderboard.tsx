...
export const Leaderboard: React.FC<Props> = ({
  ...
  React.useEffect(() => {
    rustApi
      ...
      .then((lb) => {
        useAppStore.getState().setLeaderboard(lb.entries, lb.season);
      })
      .catch(() => {});
  }, []);
      ...
      >
        ...
        <View style={styles.leagueHero}>
          ...
          <Text style={styles.leagueName}>
            {season?.leagueName ?? "Obsidian League"}
          </Text>
          <Text style={styles.leagueSubtitle}>
            {season?.division ?? "Scholars Division"} • Round{" "}
            {season?.round ?? 4} of {season?.totalRounds ?? 12}
          </Text>
        </View>
...
const LeaderboardItem = ({
  ...
  <View style={[styles.listItem, user.isMe && styles.listItemMe]}>
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.xpRow}>
        <Feather
          name="zap"
          size={13}
          color={user.isMe ? COLORS.primary : COLORS.onSurfaceVariant}
        />
    ...
    <View style={[styles.streakPill, user.isMe && styles.streakPillMe]}>
      ...
      <Text style={[styles.streakNum, user.isMe && { color: COLORS.black }]}>
        {user.streak}
      </Text>
    </View>
  </View>
